function [tcost, sequence, depth, space] = A_star_G(initial_node,goal_node)
    ...
    % close list for the node been visited
    close_alist = [];
    ...
    while ~isempty(open_list)        
        ...
        % add the removed node into closed list
        ...
        elseif(tcost>20000)
            ...
            % if the moved state is not equal to its parent state & not in
            % close list
